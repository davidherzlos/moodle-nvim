return {
  {
    ...
    config = function()
      ...
      vim.keymap.set("n", "<leader>p", function() harpoon:list():add() end, { desc = "Harpoon: Pin"})
      vim.keymap.set("n", "<leader>pl", function() harpoon.ui:toggle_quick_menu(harpoon:list()) end, { desc = "Harpoon: List" })
