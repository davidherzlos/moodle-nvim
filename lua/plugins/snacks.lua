...
return {
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>ff', function() Snacks.picker.files(picker_cfg()) end, { desc = 'Project' })
      vim.keymap.set('n', '<leader>f.', function() Snacks.picker.files(picker_cfg('closest')) end, { desc = 'Project (closest)' })
      vim.keymap.set('n', '<leader>fc', function() Snacks.picker.files(picker_cfg('config')) end, { desc = 'Config' })
      vim.keymap.set('n', '<leader>fp', function() Snacks.picker.files(picker_cfg('plugins')) end, { desc = 'Plugins' })
      vim.keymap.set('n', '<leader>fr', function() Snacks.picker.recent(picker_cfg()) end, { desc = 'Recent' })
      vim.keymap.set('n', '<leader>gg', function() Snacks.picker.grep(picker_cfg()) end, { desc = 'Project' })
      vim.keymap.set('n', '<leader>g.', function() Snacks.picker.grep(picker_cfg('closest')) end, { desc = 'Project (closest)' })
      vim.keymap.set('n', '<leader>gc', function() Snacks.picker.grep(picker_cfg('config')) end, { desc = 'Config' })
      vim.keymap.set('n', '<leader>gp', function() Snacks.picker.grep(picker_cfg('plugins')) end, { desc = 'Plugins' })
      vim.keymap.set('n', '<leader>gw', function() Snacks.picker.grep_word(picker_cfg()) end, { desc = 'Word on cursor' })
      vim.keymap.set('n', '<leader>sl', function() Snacks.picker.lines() end, { desc = 'Lines' })
